({
    ...
    help:
    {
        ...
        {
            this.com.message([src], "What do you need help with?<br/>Using commands, type 1<br/>Contacting server admins, type 2<br/>Getting source code, type 3<br/>Anything else, type 4<br/>To cancel this and go back to the chat, type exit", this.theme.INFO, true);
